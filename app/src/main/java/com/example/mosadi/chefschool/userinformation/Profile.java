...
public class Profile {
    ...
    public void edit_profile( String name,String surname,String image,String email, String phone, String idno, String classno,StudentAccountContract db){//when a user register
        //this.setUserID(id);
        this.setImage(image);//There is no image so far
        this.setName(name);
        this.setSurname(surname);
